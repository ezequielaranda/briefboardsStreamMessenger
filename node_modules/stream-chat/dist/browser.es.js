...
var StreamChat = /*#__PURE__*/function () {
  function StreamChat(key, secretOrOptions, options) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _this._logApiRequest(type, url, data, _this._addClientParams(params));

                _context.t0 = type;
                _context.next = _context.t0 === 'get' ? 8 : _context.t0 === 'delete' ? 12 : _context.t0 === 'post' ? 16 : _context.t0 === 'put' ? 20 : _context.t0 === 'patch' ? 24 : 28;
                break;

              case 8:
                _context.next = 10;
                return axios.get(url, _this._addClientParams(params));
              ...
              case 12:
                _context.next = 14;
                return axios.delete(url, _this._addClientParams(params));
              ...
              case 16:
                _context.next = 18;
                return axios.post(url, data, _this._addClientParams());
              ...
              case 20:
                _context.next = 22;
                return axios.put(url, data, _this._addClientParams());
              ...
              case 24:
                _context.next = 26;
                return axios.patch(url, data, _this._addClientParams());
              ...
              case 33:
                ...
                _context.next = 41;
                return _this.doAxiosRequest(type, url, params, data);
    ...
    if (this.node) {
      ...
      this.options = _objectSpread$2(_objectSpread$2(_objectSpread$2({}, nodeOptions), defaultOptions), options);
    } else {
      this.options = _objectSpread$2(_objectSpread$2({}, defaultOptions), options);
  ...
  _createClass(StreamChat, [{
    ...
    key: "sendFile",
    value: function () {
      var _sendFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(url, uri, name$$1, contentType, user) {
      ...
      function sendFile(_x7, _x8, _x9, _x10, _x11) {
    ...
    */
    ...
    key: "queryUsers",
    value: function () {
      var _queryUsers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(filterConditions, sort, options) {
      ...
      function queryUsers(_x12, _x13, _x14) {
    ...
    key: "addDevice",
    value: function () {
      var _addDevice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(id, push_provider) {
        var userID,
            _args12 = arguments;
        return _regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                userID = _args12.length > 2 && _args12[2] !== undefined ? _args12[2] : null;
                _context12.next = 3;
    ...
    key: "removeDevice",
    value: function () {
      var _removeDevice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(id) {
        var userID,
            _args14 = arguments;
        return _regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                userID = _args14.length > 1 && _args14[1] !== undefined ? _args14[1] : null;
                _context14.next = 3;
    ...
    value: function () {
      var _partialUpdateUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16(userObject) {
        return _regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
      ...
      function partialUpdateUser(_x23) {
    ...
    value: function () {
      ...
      function partialUpdateUsers(_x25) {
    ...
    value: function () {
      ...
      function reactivateUser(_x28, _x29) {
    ...
    value: function () {
      ...
      function deactivateUser(_x30, _x31) {
    ...
    key: "muteUser",
    value: function () {
      var _muteUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee25(targetID) {
        var userID,
            _args25 = arguments;
        return _regeneratorRuntime.wrap(function _callee25$(_context25) {
          while (1) {
            switch (_context25.prev = _context25.next) {
              case 0:
                userID = _args25.length > 1 && _args25[1] !== undefined ? _args25[1] : null;
                _context25.next = 3;
    ...
    key: "unmuteUser",
    value: function () {
      var _unmuteUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee26(targetID) {
        var currentUserID,
            _args26 = arguments;
        return _regeneratorRuntime.wrap(function _callee26$(_context26) {
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
                currentUserID = _args26.length > 1 && _args26[1] !== undefined ? _args26[1] : null;
                _context26.next = 3;
    ...
    key: "flagMessage",
    value: function () {
      var _flagMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee27(messageID) {
        var options,
            _args27 = arguments;
        return _regeneratorRuntime.wrap(function _callee27$(_context27) {
          while (1) {
    ...
    key: "flagUser",
    value: function () {
      var _flagUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee28(userID) {
        var options,
            _args28 = arguments;
        return _regeneratorRuntime.wrap(function _callee28$(_context28) {
          while (1) {
    ...
    key: "unflagMessage",
    value: function () {
      var _unflagMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee29(messageID) {
        var options,
            _args29 = arguments;
    ...
    key: "unflagUser",
    value: function () {
      var _unflagUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee30(userID) {
        var options,
            _args30 = arguments;
    ...
    key: "markAllRead",
    value: function () {
      var _markAllRead = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee31() {
        var data,
            response,
            _args31 = arguments;
    ...
    value: function () {
      ...
      function updateMessage(_x44, _x45) {
    ...
    value: function () {
      ...
      function deleteMessage(_x46, _x47) {
    ...
    value: function _addClientParams() {
      ...
      return _objectSpread$2(_objectSpread$2({}, this.options), {}, {
